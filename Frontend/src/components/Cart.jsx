        ...
        <div className="flex items-center justify-center bg-gray-100 p-6">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button onClick={() => handleCheckout()} className="w-full py-3 mt-4 bg-[#c7899e] hover:bg-[#9b5c71] text-white font-semibold rounded-lg transition duration-300">Complete Payment</button>
                </form>
